...
from amdar.viewer.graph.plotting.vertical_profile import plot_hodograph, plot_temperature_profile
...
GRAPH_DEF_MAP: dict[GraphName, GraphDefinition] = {
    ...
    "temperature_profile": GraphDefinition(
        func=plot_temperature_profile, size=(1600, 1600), file="temperature_profile.png"
    ),
    "hodograph": GraphDefinition(func=plot_hodograph, size=(1600, 1600), file="hodograph.png"),
}
